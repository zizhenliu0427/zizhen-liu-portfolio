...
const surfaces: Record<string, string> = {
  Project_Ceramic: '#c7cebd', Project_Graphite: '#283b40', Project_Amber: '#e4a24e',
  Project_Trace: '#6daba6', Project_Silver: '#aabbbd',
...
export function themeMaterial(material: THREE.Material, name: string, instanced = false, subduedIndex = { value: 0 }) {
  ...
  // Evidence screenshots retain their source colours in both website themes.
  if (name.startsWith('Project_Evidence_')) return amount;
